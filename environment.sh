...
# to work with the bl02t IOCs and Services.
...
echo "Loading environment for beamline bl02t IOC Instances and Services ..."
...
export EC_SERVICES_REPO=git@github.com:gilesknap/bl02t.git
